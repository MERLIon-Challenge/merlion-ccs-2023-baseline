...
class VoiceActivityDetector():
    ...
    def __init__(self, wave_input_filename, threshold=0.55):
        self._read_wav(wave_input_filename)._convert_to_mono()
        self.sample_window = 0.02  # 20 ms
        self.sample_overlap = 0.01  # 10ms
        self.speech_window = 0.5  # half a second
        self.speech_energy_threshold = threshold  # 100*threshold % of energy in voice band
...
if __name__ == "__main__":
    wav_path = "/Users/hexin/Desktop/3273.wav"
